...
const MppDevApi vcodec_service_api = {
    .name               = "vcodec_service",
    .ctx_size           = sizeof(MppDevVcodecService),
    .init               = vcodec_service_init,
    .deinit             = vcodec_service_deinit,
    .attach             = NULL,
    .detach             = NULL,
    .delimit            = NULL,
    .set_cb_ctx         = NULL,
    .reg_wr             = vcodec_service_reg_wr,
    .reg_rd             = vcodec_service_reg_rd,
    .reg_offset         = vcodec_service_reg_offset,
    .reg_offs           = NULL,
    .rcb_info           = NULL,
    .set_info           = vcodec_service_set_info,
    .set_err_ref_hack   = NULL,
    .set_flag           = NULL,
    .lock_map           = NULL,
    .unlock_map         = NULL,
    .attach_fd          = NULL,
    .detach_fd          = NULL,
    .cmd_send           = vcodec_service_cmd_send,
    .cmd_poll           = vcodec_service_cmd_poll,
};
