...
static const MppDecHwCap vdpu1 = {
    ...
    .cap_fbc            = SOC_CAP_FBC_NONE,
    .cap_data_layout    = SOC_CAP_RASTER,
    .cap_4k             = 0,
    .cap_8k             = 0,
...
static const MppDecHwCap vdpu34x = {
    .cap_coding         = CAP_CODING_VDPU341,
    .type               = VPU_CLIENT_RKVDEC,
    .cap_fbc            = SOC_CAP_AFBC_V2,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_AFBC16X16,
    .cap_4k             = 1,
    .cap_8k             = 1,
    .cap_colmv_compress = 1,
    .cap_hw_h265_rps    = 1,
...
static const MppDecHwCap vdpu383 = {
    ...
    .type               = VPU_CLIENT_RKVDEC,
    .cap_fbc            = SOC_CAP_RKFBC,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_RKFBC64X4 | SOC_CAP_TILE4X4,
    .cap_4k             = 1,
    .cap_8k             = 1,
    .cap_colmv_compress = 1,
    .cap_hw_h265_rps    = 1,
...
static const MppDecHwCap vdpu384a = {
    ...
    .type               = VPU_CLIENT_RKVDEC,
    .cap_fbc            = SOC_CAP_FBC_NONE,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_TILE4X4,
    .cap_4k             = 1,
    .cap_8k             = 1,
    .cap_colmv_compress = 1,
    .cap_hw_h265_rps    = 1,
...
static const MppDecHwCap vdpu384b = {
    ...
    .type               = VPU_CLIENT_RKVDEC,
    .cap_fbc            = SOC_CAP_AFBC_V1 | SOC_CAP_AFBC_V2 | SOC_CAP_RKFBC,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_AFBC32X8 | SOC_CAP_RKFBC64X4 | SOC_CAP_TILE4X4,
    .cap_4k             = 1,
    .cap_8k             = 1,
    .cap_colmv_compress = 1,
    .cap_hw_h265_rps    = 1,
...
static const MppEncHwCap vepu540 = {
    .cap_coding         = CAP_CODING_VEPU54X,
    .type               = VPU_CLIENT_RKVENC,
    .cap_fbc            = SOC_CAP_AFBC_V1 | SOC_CAP_AFBC_V2,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_AFBC16X16,
    .cap_4k             = 0,
    .cap_8k             = 0,
    .cap_hw_osd         = 1,
...
static const MppEncHwCap vepu511 = {
    ...
    .type               = VPU_CLIENT_RKVENC,
    .cap_fbc            = SOC_CAP_RKFBC,
    .cap_data_layout    = SOC_CAP_RASTER | SOC_CAP_RKFBC64X4,
    .cap_4k             = 1,
    .cap_8k             = 0,
    .cap_hw_osd         = 1,
    .cap_hw_roi         = 1,
